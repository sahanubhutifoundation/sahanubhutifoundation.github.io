...
export const initialConfig: FoundationConfig = {
  ...
  fundSnapshotCards: [
    ...
    },
    {
      ...
      description: {
        bn: 'অসুস্থ স্বজনদের ওষুধ ও চিকিৎসায় তাত্ক্ষণিক অনুমোদিত আর্থিক অনুদান।',
    ...
    },
    {
      id: 'fund-snap-3',
      title: {
        bn: 'স্বচ্ছ উন্মুক্ত হিসাব',
        en: 'Open & Audited Accounts',
        ar: 'حسابات شفافة ومفتوحة',
      },
      description: {
        bn: 'গুগল শিট ও সমন্বিত রেজিস্টারের মাধ্যমে সবার জন্য উন্মুক্ত আর্থিক হিসাব।',
  ...
  memberSerialStyle: 'minimal',
  memberSerialPosition: 'top-left',
  homeMembersCount: 8,
  homeMemberGrid: {
    desktopCols: 4,
    desktopLimit: 8,
  ...
  homeShowViewAllMembers: true,
  aboutShowBaytulMal: true,
  aboutValuesCards: [
    {
      id: 'val-1',
      title: {
        bn: 'সততা ও শতভাগ আর্থিক স্বচ্ছতা',
        en: 'Honesty & 100% Financial Transparency',
        ar: 'الصدق والشفافية المالية التامة',
      },
      description: {
        bn: 'তহবিলের প্রতিটি টাকা ও ব্যয়ের হিসাব সবার জন্য দৃশ্যমান ও উন্মুক্ত।',
        en: 'Every penny received and spent is completely open to all members.',
        ar: 'كل إيراد ومصروف واضح ومتاح للجميع بشفافية تامة.',
      },
      icon: 'ShieldCheck',
      sortOrder: 1,
      isEnabled: true,
    },
    {
      id: 'val-2',
      title: {
        bn: 'পারস্পরিক সম্মান ও ভ্রাতৃত্ববোধ',
        en: 'Mutual Respect & Kinship',
        ar: 'الاحترام المتبادل وصلة الرحم',
      },
      description: {
        bn: 'পরিবারের সকলের মতামতকে শ্রদ্ধা জানিয়ে সুদৃঢ় ভ্রাতৃত্ব বজায় রাখা।',
        en: 'Respecting everyone’s perspective and upholding genuine fraternal bonds.',
        ar: 'احترام آراء الجميع وترسيخ روابط الأخوة الصادقة.',
      },
      icon: 'Users',
      sortOrder: 2,
      isEnabled: true,
    },
    {
      id: 'val-3',
      title: {
        bn: 'কোনো প্রদর্শনপ্রিয়তা নয়, আন্তরিক মানবকল্যাণ',
        en: 'Sincerity Over Ostentation',
        ar: 'الإخلاص لوجه الله بعيداً عن المظاهر',
      },
      description: {
        bn: 'লোকদেখানো প্রচার এড়িয়ে নিভৃতে সত্যিকারের প্রয়োজনগ্রস্তদের পাশে দাঁড়ানো।',
        en: 'Avoiding publicity while quietly aiding those genuinely in distress.',
        ar: 'الوقوف مع ذوي الحاجة الحقيقية بصمت وإخلاص دون رياء.',
      },
      icon: 'Heart',
      sortOrder: 3,
      isEnabled: true,
    },
    {
      id: 'val-4',
      title: {
        bn: 'শৃঙ্খলা ও ঐক্যবদ্ধ সিদ্ধান্ত',
        en: 'Discipline & Collective Decisions',
        ar: 'الانضباط والقرار الجماعي',
      },
      description: {
        bn: 'সকল গুরুত্বপূর্ণ বিষয়ে গঠনমূলক পরামর্শের মাধ্যমে ঐক্যমতে পৌঁছানো।',
        en: 'Reaching consensus through constructive consultation on all key matters.',
        ar: 'الوصول إلى قرارات موحدة بالشورى البناءة في كافة الأمور الهامة.',
      },
      icon: 'CheckCircle2',
      sortOrder: 4,
      isEnabled: true,
  ...
  aboutFutureCards: [
    {
      id: 'fut-1',
      title: {
        bn: 'স্থায়ী বাইতুল মাল তহবিলের বিস্তার',
        en: 'Expansion of Permanent Baytul Mal',
        ar: 'توسيع رصيد بيت المال الدائم',
      },
      description: {
        bn: 'নিয়মিত সদস্য সহায়তায় একটি টেকসই ও শক্তিশালী জরুরি ফান্ড গড়ে তোলা।',
        en: 'Building a sustainable and strong safety fund via consistent contributions.',
        ar: 'بناء صندوق أمان مستدام وقوي بمساهمات الأعضاء المنتظمة.',
      },
      icon: 'Wallet',
      sortOrder: 1,
      isEnabled: true,
    },
    {
      id: 'fut-2',
      title: {
        bn: 'অসুস্থ ও অসহায় স্বজনদের জরুরি চিকিৎসা ফান্ড',
        en: 'Emergency Medical Care Fund',
        ar: 'صندوق الرعاية الطبية الطارئة',
      },
      description: {
        bn: 'জরুরি প্রেসক্রিপশন ওষুধ, পরীক্ষা ও চিকিৎসার ব্যয়ভার বহনে সহায়তা।',
        en: 'Facilitating emergency prescription medicines, diagnostics, and treatments.',
        ar: 'توفير تكاليف الأدوية الضرورية والفحوصات الطبية للحالات الطارئة.',
      },
      icon: 'Stethoscope',
      sortOrder: 2,
      isEnabled: true,
    },
    {
      id: 'fut-3',
      title: {
        bn: 'পারিবারিক মেধাবী সন্তানদের শিক্ষাবৃত্তি ও সহায়তা',
        en: 'Merit Scholarships & Education Aid',
        ar: 'منح دراسية ودعم للطلبة المتفوقين',
      },
      description: {
        bn: 'পারিবারিক শিক্ষার্থীদের শিক্ষা উপকরণ ও মেধার স্বীকৃতিতে বৃত্তি প্রদান।',
        en: 'Providing educational materials and scholarships acknowledging talent.',
        ar: 'تقديم المواد التعليمية والمنح تقديراً للتفوق العلمي.',
      },
      icon: 'GraduationCap',
      sortOrder: 3,
      isEnabled: true,
    },
    {
      id: 'fut-4',
      title: {
        bn: 'ভবিষ্যতে বৃহত্তর সমাজে সেবামূলক উদ্যোগের দ্বার উন্মোচন',
        en: 'Expanding Welfare Initiatives to Wider Society',
        ar: 'فتح آفاق الخير لخدمة المجتمع الأوسع',
      },
      description: {
        bn: 'পর্যায়ক্রমে সততা ও সক্ষমতা বজায় রেখে বৃহত্তর সামাজিক কল্যাণে অংশ নেওয়া।',
        en: 'Gradually participating in broader community welfare with integrity.',
        ar: 'المشاركة تدريجياً في برامج النفع العام للمجتمع بكل نزاهة وكفاءة.',
      },
      icon: 'Globe',
      sortOrder: 4,
      isEnabled: true,
  ...
  yearlyFundSources: [
    ...
    },
    {
      ...
      enabled: true,
      isPublic: true,
      notes: '২০২৫ সালের সংগৃহীত তহবিল আর্কাইভ',
    },
    {
      year: '2024',
      url: '',
      ...
      enabled: true,
      isPublic: true,
      notes: 'প্রতিষ্ঠাকালীন ২০২৪ সালের তহবিল আর্কাইভ',
    },
  ],
  fundReconciliationMode: 'detailed_ledger',
  fundExpenseHeadings: {
  ...
  contactPageConfig: {
    pageTitle: {
      bn: 'যোগাযোগ ও সরাসরি পরামর্শ',
      en: 'Contact & Inquiries',
      ar: 'التواصل والاستفسارات',
    },
    pageSubtitle: {
      bn: 'সহানুভূতি ফাউন্ডেশনের সাথে যুক্ত হতে বা যেকোনো পরামর্শে আমাদের বার্তা পাঠান',
      en: 'Reach out to join Sahanubhuti Foundation or share your valuable suggestions',
      ar: 'تواصل معنا للانضمام إلى مؤسسة ساهانوبوتي أو مشاركة اقتراحاتك القيمة',
    },
    formTitle: {
    ...
    formSubtitle: {
      bn: 'ফর্মটি পূরণ করে সাবমিট করলে এটি সরাসরি অ্যাডমিন ইনবক্সে সংরক্ষিত হবে।',
      en: 'Submitting this form stores your message directly in our administrator inbox.',
      ar: 'إرسال هذا النموذج يحفظ رسالتك مباشرة في صندوق بريد المشرف.',
    },
    nameLabel: 'আপনার পূর্ণ নাম',
    namePlaceholder: 'যেমন: মোহাম্মদ আবদুল্লাহ',
    emailLabel: 'ইমেইল ঠিকানা',
    emailPlaceholder: 'yourname@example.com',
    phoneLabel: 'ফোন নম্বর (ঐচ্ছিক)',
    phonePlaceholder: '+880 1...',
    isPhoneRequired: false,
    subjectLabel: 'বিষয় (ঐচ্ছিক)',
    subjectPlaceholder: 'যেমন: সদস্য হওয়ার আবেদন / আর্থিক পরামর্শ',
    isSubjectRequired: false,
    messageLabel: 'আপনার বার্তা / বিস্তারিত',
    messagePlaceholder: 'আপনার বার্তা বিস্তারিত লিখুন...',
    submitButtonText: 'বার্তা পাঠান',
    submittingText: 'পাঠানো হচ্ছে...',
    successTitle: 'আপনার বার্তা সফলভাবে গৃহীত হয়েছে',
    successMessage: 'আপনার প্রেরিত বার্তাটি নিরাপদে সংরক্ষিত হয়েছে। ইনশাআল্লাহ দ্রুত যোগাযোগ করা হবে।',
    sendAnotherText: 'আরেকটি বার্তা পাঠান',
  },
  fundVisibility: {
    ...
    showSafetyRatio: true,
    showYearlyOverview: true,
    showHistoricalYears: true,
    showActivityLinkedExpenses: true,
